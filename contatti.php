...
<head>
    ...
    <div id="contentmail">
      <ul class="form-style-1">
        <li>
          ...
          <input type="text" name="field1" id="nome" class="field-divided" placeholder="Nome" required>&nbsp;
          <input type="text" name="field2" id="cognome" class="field-divided" placeholder="Cognome" />
        </li>
        <li>
          <label>Email
            <span class="required">*</span>
  ...
  <div class='divcontatti hidden-xs'>
    ...
    <div>
      <img src='img/iPhone-icon.png'><b>347 597 4981</b></div>
    <div>
      <a href='http://lelloxd.altervista.org'>
        <img src='img/web-icon.png'>
      </a><b>Website Designed By <a href='http://lelloxd.altervista.org'>Antonello Fraioli</a></b></div>
  </div>
